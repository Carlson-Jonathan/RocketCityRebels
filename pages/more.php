...
<body background="../images/background.jpg">
    ...
    <main>
        ...
        <div class="row">
            ...
            <div class="columnright">
                <form action="" method="get">
                    Name:
                    <input type="text" width="500px" placeholder="John Doe"><br><br>
                    Email:
        ...
        <h1 class="bar">Rebels on Social Media:</h1>  
